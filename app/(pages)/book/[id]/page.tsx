...
async function page({ params }: { params: Promise<{ id: string }> }) {
  ...
  return (
    <>
      ...
      <section className="max-w-350 mx-auto px-12 pb-20 grid grid-cols-[320px_1fr] gap-16 items-start animate-fade-in-scale">
        <aside className="sticky top-25 flex flex-col gap-6">
        ...
        <div className="flex flex-col gap-10">
          ...
          <div className="grid grid-cols-2 border border-(--border-color)">
