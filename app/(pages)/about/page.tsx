...
export default function page() {
  return (
    <section className="max-w-350 mx-auto py-20 px-12 text-center animate-fade-in-scale">
      <div className="mb-20">
        <h1 className="font-playfair text-[4rem] font-bold mb-6 tracking-wide leading-[1.2]">
          A Sanctuary for <br />
          Literary Minds
        </h1>
        <p className="text-2xl text-(--text-secondary) font-light max-w-175 mx-auto leading-[1.8]">
      ...
      <div className="max-w-225 mx-auto py-16 px-12 text-left">
        <span className="font-sans text-sm uppercase tracking-widest text-(--accent) mb-6 font-semibold">
          Our Story
        </span>
        <h2 className="font-playfair text-[2.5rem] font-bold mt-6 mb-8 text-(--text-primary) leading-[1.3]">
      ...
      <div className="bg-(--bg-secondary) py-20 px-12">
        <div className="mb-16">
          <span className="font-sans text-sm uppercase tracking-widest text-(--accent) mb-6 font-semibold">
            What We Believe
          </span>
      ...
      <div className="max-w-225 mx-auto pt-16 py-12 pb-20">
        <blockquote className="font-playfair text-[2rem] italic text-(--text-primary) leading-[1.6] mb-6 relative before:content-['“'] before:absolute before:-left-8 before:-top-4 before:text-[4rem] before:text-(--accent) before:opacity-30">
      ...
      <div className="py-20 px-12 bg-(--bg-secondary)">
