...
function page() {
  return (
    <section className="flex flex-1 items-center justify-center py-8 px-4 sm:py-12 sm:px-8 animate-fade-in-scale">
      <div className="flex flex-col lg:flex-row max-w-275 w-full bg-card border border-(--border-color) overflow-hidden shadow-[0_20px_60px_var(--shadow)]">
        {/* Sidebar Section */}
        <div
          className="flex flex-1 flex-col justify-center text-white relative overflow-hidden py-8 px-6 sm:py-12 sm:px-8 lg:py-16 lg:px-12 before:content-[''] before:absolute before:top-0 before:left-0 before:right-0 before:bottom-0 before:opacity-100 auth-sidebar"
          style={{
            background:
        ...
        >
          <div className="relative z-1">
            <h2 className="font-playfair text-[2rem]/8 lg:text-[2.5rem]/11 font-bold mb-6">
        ...
        {/* Form Section */}
        <div className="flex flex-1 flex-col justify-center py-8 px-6 sm:py-12 sm:px-8 lg:py-16 lg:px-12">
          <div className="mb-10">
            <h1 className="font-playfair text-2xl sm:text-[2rem] font-semibold text-[--text-primary] mb-2">
              Get Started
            </h1>
